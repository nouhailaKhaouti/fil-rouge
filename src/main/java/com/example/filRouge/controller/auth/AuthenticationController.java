package com.example.filRouge.controller.auth;
...
public class AuthenticationController {
    ...
    public ResponseEntity<?> register(@Valid @RequestBody() requestMember requestmember) throws MessagingException, IOException {
